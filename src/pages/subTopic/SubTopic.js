            ...
            <div className="row px-3 mt-3 materialTable">
                ...
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {subTopic.map((row, index) => <SingleSubTopicRow changeSubTopicStatus={changeSubTopicstatus} row={row} index={index} openDeleteAlertModal={openDeleteAlertModal} topicID={topicID} />
                            )}
