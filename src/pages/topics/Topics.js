            ...
            <div className="row px-3 mt-3 materialTable">
                ...
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {topics?.map((row, index) => <SingleTopicRow courseID={courseID} changeTopicStatus={changeTopicStatus} row={row} index={index} openDeleteAlertModal={openDeleteAlertModal} />
                            )}
